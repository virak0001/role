                    ...
                    <div class="card mt-1">
                      <div class="card-header ">
                       <div class="row">
                        ...
                        <div class="col-11">
                          <small class="ml-2">{{$students['first_name']}}.{{$students['last_name']}}</small><br><br>
                          @foreach ($students->comments as $comment)
                            <p style="font-size:16px">
                              ...
                              @if (Auth::id() == $comment->user_id)
                                ...
                                <a href="{{route('admin.deleteComment',$comment->id)}}"><i class="material-icons text-primary"  data-toggle="tooltip" data-placement="top" title="delete" style="font-size:10px">delete</i></a><br>
                              @endif
                            </p>
                          @endforeach
                         </div>
                      ...
                      <div class="card-footer">
                        <form id="inserComment" action="#" method="post">
                          @csrf
                          @method('PUT')
                        ...
                        <form id="editForm" action="{{route('admin.editComment',[$students->id])}}" method="post">
                          @csrf
                          @method('PUT')
